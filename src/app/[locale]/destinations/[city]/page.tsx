...
const cityData: Record<string, {
  ...
  makkah: {
    ...
    heroImage: '/images/hero-kaaba-night.jpg',
    ...
    images: [
      { src: '/images/kaaba.jpg', caption: 'The Holy Kaaba — Masjid al-Haram' },
      { src: '/images/hero-kaaba-night.jpg', caption: 'Tawaf at night under the mosque lights' },
      { src: '/images/jabal-noor.jpg', caption: 'Jabal al-Noor — Cave of Hira where the Quran was first revealed' },
      { src: '/images/hotel-makkah-exterior.jpg', caption: 'Luxury hotels near the Haram complex' },
      { src: '/images/hotel-makkah-room.jpg', caption: '5-star hotel rooms with Haram proximity' },
      { src: '/images/hotel-buffet.jpg', caption: 'International buffet dining at partner hotels' },
    ],
  },
  madina: {
    title: 'Madina al-Munawwarah',
    subtitle: 'The radiant city of the Prophet ﷺ',
    heroImage: '/images/madina-nabawi-sunset.jpg',
    ...
    images: [
      { src: '/images/madina.jpg', caption: 'Masjid an-Nabawi — The Prophet\'s Mosque' },
      { src: '/images/madina-nabawi-sunset.jpg', caption: 'The Green Dome at sunset' },
      { src: '/images/masjid-quba.jpg', caption: 'Masjid Quba — the first mosque in Islam' },
      { src: '/images/masjid-qiblatain.jpg', caption: 'Masjid al-Qiblatain — where the Qibla changed' },
      { src: '/images/mount-uhud.jpg', caption: 'Mount Uhud — site of the Battle of Uhud' },
      { src: '/images/hotel-madina-lobby.jpg', caption: 'Grand hotel lobbies in Madina' },
    ],
  },
  jeddah: {
    title: 'Jeddah',
    subtitle: 'Gateway to the Holy Land and Saudi Arabia\'s Red Sea port city',
    heroImage: '/images/hotel-makkah-exterior.jpg',
    ...
    images: [
      { src: '/images/airport-terminal.jpg', caption: 'Modern arrival terminals' },
      { src: '/images/airline-saudia.jpg', caption: 'Direct flights from Pakistan' },
      { src: '/images/hotel-makkah-exterior.jpg', caption: 'Modern Jeddah architecture' },
    ],
  },
  riyadh: {
    title: 'Riyadh',
